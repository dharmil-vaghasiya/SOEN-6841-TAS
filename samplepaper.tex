...
\begin{figure}[h]
  \begin{minipage}{0.48\textwidth}
    ...
    \caption[Effect of Interaction between \ac{GM} Openness and Subordinate Performance on Employee Voice]{Effect of Interaction between GM Openness and Subordinate Performance on Employee Voice. Adapted from 'Leadership behavior and employee voice: Is the door really open?' by J. R. Detert and E. R. Burris, 2007, \textit{Academy of Management Journal}, 50(4), 869-884.}
    \label{fig:figure1}
  \end{minipage}
\hfill
  \begin{minipage}{0.48\textwidth}
